    ...
    rsx! {
        div {
            input {
                ...
                class: "block w-full bg-white text-gray-800 px-3 py-2 rounded-lg focus:border-red-900 mb-2",
                oninput: move |event| {
            ...
            textarea {
                ...
                class: "block w-full bg-white text-gray-800 px-3 py-2 rounded-lg focus:border-red-900 mb-2 field-sizing-content",
                oninput: move |event| {
